...
describe OmniAuth::Strategies::FacturaSeguro do
  ...
  let(:enterprise) do
    OmniAuth::Strategies::FacturaSeguro.new('FACTURASEGURO_KEY', 'FACTURASEGURO_SECRET',
        {
            :client_options => {
  ...
  subject do
    OmniAuth::Strategies::FacturaSeguro.new({})
  end
  ...
  context "client options" do
    it 'should have correct site' do
      subject.options.client_options.site.should eq("https://login.facturaseguro.cl")
    end

    it 'should have correct authorize url' do
      subject.options.client_options.authorize_url.should eq('https://login.facturaseguro.cl/login/oauth/authorize')
    end

    it 'should have correct token url' do
      subject.options.client_options.token_url.should eq('https://login.facturaseguro.cl/login/oauth/access_token')
    end
